...
public class TopicServiceTest {
    /**
     * 1. Режим topic. Подписываемся на топик weather. client407.
     * 2. Режим topic. Добавляем данные в топик weather.
     * 3. Режим topic. Забираем данные из индивидуальной очереди в топике weather. Очередь client6565.
